...
void init() {
    ...
    uintptr_t optifineZoombaseAddress = gameId + 0x09024EA8;
    uintptr_t __optifineZoomPtr = l->findAddressFromPointer(process_handle, optifineZoombaseAddress, { 0x20, 0x8, 0x198, 0x18 });
